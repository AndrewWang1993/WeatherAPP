...
import com.github.mikephil.chartLibrary.data.BarData;
import com.github.mikephil.chartLibrary.data.BarDataSet;
import com.github.mikephil.chartLibrary.data.ChartData;
import com.github.mikephil.chartLibrary.data.DataSet;
import com.github.mikephil.chartLibrary.data.Entry;
import com.github.mikephil.chartLibrary.data.PieDataSet;
...
import com.github.mikephil.chartLibrary.utils.ValueFormatter;
...
public abstract class Chart<T extends ChartData<? extends DataSet<? extends Entry>>> extends View
    ...
    protected void init() {
        ...
        mXLabelPaint.setTextSize(Utils.convertDpToPixel(25f));  //调节XLabel上空隙
    ...
    protected void drawLegend() {
        ...
        mLegendLabelPaint.setTextSize(20);
        mLegendFormPaint.setTextSize(10);    //修改legend彩色线段长

        mLegend.setTextSize(30);
        mLegend.setFormSize(50);
...
//                        mLegendLabelPaint.setTextSize(20);
     ...
     * @param t
     */
    public void setDescriptionTypeface(Typeface t, int size,int color) {
        mDescPaint.setTypeface(t);
        mDescPaint.setTextSize(size);
        mDescPaint.setColor(color);
    }

    public void setLegendLabelPaint(int size,int color) {
        mLegendLabelPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mLegendLabelPaint.setTextSize(Utils.convertDpToPixel(size));
