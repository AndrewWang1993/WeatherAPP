...
package com.github.mikephil.chartLibrary.charts;
...
import com.github.mikephil.chartLibrary.data.BarDataSet;
import com.github.mikephil.chartLibrary.data.BarLineScatterCandleData;
import com.github.mikephil.chartLibrary.data.BarLineScatterCandleRadarDataSet;
import com.github.mikephil.chartLibrary.data.Entry;
import com.github.mikephil.chartLibrary.data.filter.Approximator;
import com.github.mikephil.chartLibrary.interfaces.OnDrawListener;
import com.github.mikephil.chartLibrary.listener.BarLineChartTouchListener;
import com.github.mikephil.chartLibrary.utils.Highlight;
import com.github.mikephil.chartLibrary.utils.Legend.LegendPosition;
import com.github.mikephil.chartLibrary.utils.LimitLine;
import com.github.mikephil.chartLibrary.utils.LimitLine.LimitLabelPosition;
import com.github.mikephil.chartLibrary.utils.PointD;
import com.github.mikephil.chartLibrary.utils.SelInfo;
import com.github.mikephil.chartLibrary.utils.Utils;
import com.github.mikephil.chartLibrary.utils.XLabels;
import com.github.mikephil.chartLibrary.utils.XLabels.XLabelPosition;
import com.github.mikephil.chartLibrary.utils.YLabels;
import com.github.mikephil.chartLibrary.utils.YLabels.YLabelPosition;
    ...
    protected void drawXLabels(float yPos) {
        ...
        for (int i = 0; i < mCurrentData.getXValCount(); i += mXLabels.mXAxisLabelModulus) {
            ...
            if (position[0] >= mOffsetLeft && position[0] <= getWidth() - mOffsetRight) {
                ...
                mXLabelPaint.setTextSize(20);   mXLabelPaint.setColor(Color.LTGRAY);    ///懒了
                mDrawCanvas.drawText(label, position[0]-8,
                        yPos-5,
                        mXLabelPaint);
            }
        }
